...
const f = new __WEBPACK_IMPORTED_MODULE_2__flock3d__["a" /* default */](300, vw, vh, 1500);
f.populateFlock();
...
class Flocky {
  ...
  getSliderVals() {
    $('#cohesion').on('change', (change, ui) => {
      this.cohesion = ui.value;
    });
  }
...
class Birdy {
  ...
  move() {
    ...
    if (mag > 7) {
      this.vel[0] = this.vel[0] / mag * 7;
      this.vel[1] = this.vel[1] / mag * 7;
      this.vel[2] = this.vel[2] / mag * 7;
    }
